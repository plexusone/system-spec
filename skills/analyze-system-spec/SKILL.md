---
name: analyze-system-spec
description: Analyze, validate, and visualize system-spec infrastructure files
triggers:
  - analyze-system-spec
  - analyze system
...
```bash
graphize query svc:api-gateway   # Find what code implements a service
graphize path "svc:payment-processor" "rds:main-db"  # Trace connections
```
